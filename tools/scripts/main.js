...
function sspmessage (name) {
  ...
  else if (name == "Chess Battle Advanced") {shtn = randarray(["CheBA", "CheB.A.", "ChBA", "Ch. B. A.", "CBA", "CBAdv", "ChBaAd", "ChBAdv"])}
